        ...
        <tr>
            <td align="center"
                ...
                <table class="content" width="100%" cellpadding="0" cellspacing="0" role="presentation"
                    ...
                    <!-- Email Body -->
                    <tr>
                        <td style="font-family: Arial, sans-serif; background-color: #f9f9f9; padding: 20px; border: 1px solid #ddd;">
                            <div style="margin: 20px; line-height: 1.6; color: #333;">
                                <p style="margin-bottom: 15px; font-size: 16px;">Assalammualaikum/Salam Sejahtera,</p>
                                
                                <p style="margin-bottom: 10px;">{{ $receiver }},</p>
                            ...
                            <div style="margin: 20px; line-height: 1.6; color: #333;">
                                <p style="margin-bottom: 20px;">{{ $footer }}</p>
