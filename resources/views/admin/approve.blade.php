...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4" style="margin-top: 20px;">
        <div>
            ...
            <span class="h6 mb-0 text-gray-500 ml-2">Approve</span>
        </div>
    ...
    <div class="col">
        <div class="row">
            <div class="alert alert-success" role="alert">
                ...
                <p>We are pleased to inform you that this application has been approved successfully.</p>
            </div>
        </div>
    </div>
                                ...
                                <div class="card shadow-sm">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="applicationRemark" class="form-control" id="applicationRemark" rows="4" disabled>{{ $intec_sdr_application->applications_remark ?? 'N/A' }}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
