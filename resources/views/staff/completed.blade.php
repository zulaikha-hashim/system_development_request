...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4" style="margin-top: 20px;">
        <div>
            ...
            <span class="h6 mb-0 text-gray-500 ml-2"> {{ $intec_sdr_application->status->status_name}}</span>
        </div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0" style="background-color: transparent; border: none;">
                ...
                <li class="breadcrumb-item active" aria-current="page"> {{ $intec_sdr_application->status->status_name}}</li>
            </ol>
        </nav>
    </div>
            ...
            <div class="card shadow mb-4 w-100"> 
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <div class="col text-right"> 
                        <a href="{{ route('generate.report', ['applications_id' => $applications_id]) }}" target="_blank"
                            class="btn btn-primary" style="padding: 6.4px 10px; font-size: 0.875rem;">
                        ...
                        <div class="card shadow-sm w-100"> 
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-8">
                                        {{ $intec_sdr_application->developer->dev_name ?? 'N/A' }}
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-6">
                                        @if (isset($file))
                                            <a target="_blank" href="/get-file/{{ $file->applications_id }}"
                                                class="btn btn-secondary btn-sm"><i class="bi bi-file-earmark-text"></i>
                                                View Document</a>
                                        @else
                                            <button class="btn btn-danger btn-sm" disabled><i class="fi fi-x-circle"></i>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary"><i class="bi bi-file-earmark-text-fill"></i> System Documentation</h6>
        </div>
        <div class="card-body">
                        ...
                        <div class="container">
                                ...
                                <div class="col-3 text-end">
                                    @if (isset($fileSR))
                                        <a target="_blank" href="/get-file/system-requirement/{{ $fileSR->doc_id }}"
                                            class="btn btn-primary btn-sm"><i class="bi bi-file-earmark-pdf"></i> View
                                            Document</a>
                                    @else
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-3 text-end">
                                    @if (isset($fileERD))
                                        <a target="_blank"
                                            href="/get-file/entity-relationship-model/{{ $fileERD->doc_id }}"
                                            class="btn btn-primary btn-sm"><i class="bi bi-file-earmark-pdf"></i> View
                                            Document</a>
                                    @else
                                        <button class="btn btn-danger btn-sm" disabled><i class="bi bi-x-circle"></i> Not
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-3 text-end">
                                    @if (isset($fileSIT))
                                        <a target="_blank"
                                            href="/get-file/system-integration-testing/{{ $fileSIT->doc_id }}"
                                            class="btn btn-primary btn-sm"><i class="bi bi-file-earmark-pdf"></i> View
                                            Document</a>
                                    @else
                                        <button class="btn btn-danger btn-sm" disabled><i class="bi bi-x-circle"></i> Not
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-3 text-end">
                                    @if (isset($fileUAT))
                                        <a target="_blank"
                                            href="/get-file/user-accecptance-testing/{{ $fileUAT->doc_id }}"
                                            class="btn btn-primary btn-sm"><i class="bi bi-file-earmark-pdf"></i> View
                                            Document</a>
                                    @else
                                        <button class="btn btn-danger btn-sm" disabled><i class="bi bi-x-circle"></i> Not
