...
@section('content')
            ...
            <div class="card shadow mb-4 w-100">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-bell"></i> System Development Request
                        Details</h6>
                    <div class="col text-right"> <!-- Right-aligned button -->
                                    ...
                                    <div class="col-6">
                                        @if (isset($file))
                                            <a target="_blank" href="/get-file/{{ $file->applications_id }}"
                                                ...
                                                View Document</a>
                                        @else
                                            <button class="btn btn-danger btn-sm" disabled><i class="bi bi-x-circle"></i>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary"><i class="bi bi-file-earmark-text-fill"></i> System
                Documentation</h6>
        </div>
        <div class="card-body">
                        ...
                        <div class="container">
                            <div class="row mb-3">
                                ...
                                <div class="col-3 text-end">
                                    @if (isset($fileSR))
                                        <a target="_blank"
                                            href="/get-file/system-requirement/{{ $fileSR->doc_id }}"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-3 text-end">
                                    @if (isset($fileSF))
                                        <a target="_blank"
                                            href="/get-file/system-flowchart/{{ $fileSF->doc_id }}"
                                            class="btn btn-primary btn-sm"><i class="bi bi-file-earmark-pdf"></i> View
                                            Document</a>
                                    @else
                                        <button class="btn btn-danger btn-sm" disabled><i class="bi bi-x-circle"></i> Not
